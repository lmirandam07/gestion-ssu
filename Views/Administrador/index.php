        ...
        <div class="columns is-gapless is-fluid">
            ...
            <div class="column is-half is-gapless container_darkgray level-item">
                    <div class="columns is-centered is-multiline">
                        ...
                        <div class="column is-12 is-gapless  is-centered">
                            <p><a href="../../route.php?controller=Ver_Propuestas" class="has_text_link has-text-centered is-size-5 level-item has-text-weight-medium"><span>Ver Propuestas</span><span class="icon"><i class="fas fa-chevron-right"></i></i></span></a></p>
                        </div>
                        <div class="column is-offset-12 is-gapless"></div>
                    </div>
            </div>
